...
floorMid2 = 8632.4
# -----6 layer--------------------
y_layer_starts = [8550, 8631.6, 9811.6, 9893.2, 9974.8, 10056.4, 10138] # 5 layer 
z_wall_starts = [10900, 10981.6, 11063.2, 11144.8, 11226.4] # 5 layer
back_top =  y_layer_starts[3] # 5 layer
...
class MaterialVeto:
    ...
    def MinChi2(vertex):
        ...
        """
        materials = MaterialVeto.MakeMaterials()
        min_chi2 = None
        for material in materials:
    ...
    def MinMinDistance(vertices, materials):
        """
    ...
    def MaxMinDistance(vertices, materials):
        """
